...
##ANCLAS##
    ...
    ANCHOR_SCALAS =    [
                        [0.34 *200,      0.33184524 *200],
                        [0.275*200,      0.47321429 *200],
                        [0.55 *200,      0.70676692 *200],
                        [0.43 *200,      0.66165414 *200],
                        [0.63 *200,      0.275      *200],
                        [0.735*200,      0.51961538 *200],
                        [0.355*200,      0.52649123 *200],
                        [0.245*200,      0.328      *200],
                        [0.385*200,      0.405      *200],
                        [0.485*200,      0.45864662 *200],
                        [0.17 *200,      0.23067164 *200],#
                        [0.795*200,      0.83       *200]
                        ]
...
class Configuracion:
    ...
    ##APRENDIZAJE##
        ...
        # Minimum probability value to accept a detected instance
        # ROIs below this threshold are skipped
        self.DETECTION_MIN_CONFIDENCE = config.getfloat("APRENDIZAJE", "DETECTION_MIN_CONFIDENCE")
        # Non-maximum suppression threshold for detection
