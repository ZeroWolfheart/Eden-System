...
class Red:
    ...
    def construir_Conv19(self, config):
        ...
        ##############################################################################
        # Bloque 1
        y = KL.Conv2D(32, kernel_size=3, activation='relu', padding="same", name="C1")(x)
        # Reescalado 1
        y = KL.MaxPool2D(pool_size=(2,2), strides=2, padding='same', name="MxP1")(y)
        # Bloque 2
        y = KL.Conv2D(64, kernel_size=3, activation='relu', padding="same", name="C2")(y)
        # Reescalado2
        y = KL.MaxPool2D(pool_size=(2,2), strides=2, padding='same', name="MxP2")(y)
        # Bloque 3
        y = KL.Conv2D(128, kernel_size=3, activation='relu', padding="same", name="C3")(y)
        y = KL.Conv2D(64,  kernel_size=1, activation='relu', padding="same", name="C4")(y)
        y = KL.Conv2D(128, kernel_size=3, activation='relu', padding="same", name="C5")(y)
        # Reescalado 3
        y = KL.MaxPool2D(pool_size=(2,2), strides=2, padding='same', name="MxP3")(y)
        # Bloque 4
        y = KL.Conv2D(256, kernel_size=3, activation='relu', padding="same", name="C6")(y)
        y = KL.Conv2D(128, kernel_size=1, activation='relu', padding="same", name="C7")(y)
        y = KL.Conv2D(256, kernel_size=3, activation='relu', padding="same", name="C8")(y)
        # Reescalado 4
        y = KL.MaxPool2D(pool_size=(2,2), strides=2, padding='same', name="MxP4")(y)
        # Bloque 5
        y = KL.Conv2D(512, kernel_size=3, activation='relu', padding="same", name="C9")(y)
        y = KL.Conv2D(256, kernel_size=1, activation='relu', padding="same", name="C10")(y)
        y = KL.Conv2D(512, kernel_size=3, activation='relu', padding="same", name="C11")(y)
        y = KL.Conv2D(256, kernel_size=1, activation='relu', padding="same", name="C12")(y)
        y = KL.Conv2D(512, kernel_size=3, activation='relu', padding="same", name="C13")(y)
        # Reescalado 5
        y = KL.MaxPool2D(pool_size=(2,2), strides=2, padding='same', name="MxP5")(y)
        # Bloque 6
        y = KL.Conv2D(1024, kernel_size=3, activation='relu', padding="same", name="C14")(y)
        y = KL.Conv2D(512,  kernel_size=1, activation='relu', padding="same", name="C15")(y)
        y = KL.Conv2D(1024, kernel_size=3, activation='relu', padding="same", name="C16")(y)
        y = KL.Conv2D(512,  kernel_size=1, activation='relu', padding="same", name="C17")(y)
        y = KL.Conv2D(1024, kernel_size=3, activation='relu', padding="same", name="C18")(y)
        y = KL.Conv2D(1000, kernel_size=1, activation='relu', padding="same", name="C19")(y)
        ###################################################################################
        # Red totalmente conectada (perceptrón)
        # Para clasificación y predicción de coordenadas
        ####################################################################################
